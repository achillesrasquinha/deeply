...
from deeply              import __name__ as NAME, __version__
from deeply.util.system  import pardir, makedirs, touch
from deeply.util.environ import getenv
from deeply.util.types   import auto_typecast
from deeply.util._dict   import autodict
from deeply._compat      import iteritems, configparser as cp
