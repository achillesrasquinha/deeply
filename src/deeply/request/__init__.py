...
from deeply.request.response import Response
from deeply.util.string      import safe_encode
from deeply.log              import get_logger

logger = get_logger()

# YAGNI: This patched "requests" works only for deeply's use-cases.
