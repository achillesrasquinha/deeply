...
class AutoEncoder(BaseModel):
    ...
    def compile(self, *args, **kwargs):
        ...
        self.loss_fn["encoder"] = kwargs.pop("encoder_loss", DEFAULT["generative_model_encoder_loss"])
        self.loss_fn["decoder"] = kwargs.pop("decoder_loss", DEFAULT["generative_model_decoder_loss"])
